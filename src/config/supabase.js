...
// Human-readable label describing where data is stored right now.
export const sourceLabel = supabaseEnabled
  ? 'Supabase (semua pengunjung)'
  : 'localStorage (browser ini saja)'
