...
// Source detection priority: UTM → in-app browser (Instagram/FB/TikTok…) →
// referrer host → "Direct".

import { getDeviceId } from './deviceManager'

// A stable, first-party visitor id. We reuse the existing deviceId so history
// from the JSONBin era (keyed by deviceId) stays consistent.
export const getVisitorId = () => getDeviceId()
